...
public class InformationEstimator implements InformationEstimatorInterface {
	...
	public static void main(String[] args) {
		...
		myObject.setSpace("3213233430120310230130103103230123201030210310320103012301301".getBytes());
		myObject.setTarget("0021020121".getBytes());
		value = myObject.estimation();
		System.out.println(">0021020121 "+value);
