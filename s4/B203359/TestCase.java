...
public class TestCase {
  public static void main(String[] args) {
    ...
    try {
      ...
      freq = myObject.frequency();
      if (-1 != freq) {
        System.out.println("frequency() for hoge, should return -1, when taget is \"\". But it returns " + freq);
        c++;
      }
      ...
      freq = myObject.frequency();
      if (-1 != freq) {
        System.out.println("frequency() for hoge, should return -1, when taget is (not set). But it returns " + freq);
        c++;
      }
      ...
      freq = myObject.frequency();
      if (0 != freq) {
        System.out.println("frequency() for \"\", should return -1, when taget is hoge. But it returns " + freq);
        c++;
      }
      ...
      freq = myObject.frequency();
      if (0 != freq) {
        System.out.println("frequency() for (not set), should return -1, when taget is hoge. But it returns " + freq);
        c++;
      }

      myObject = new Frequencer();
      myObject.setSpace("AAAAAAA".getBytes());
      myObject.setTarget("AAA".getBytes());
      freq = myObject.frequency();
      if (5 != freq) {
        System.out.println("frequency() for AAAAAAA, should return 5, when taget is AAA. But it returns " + freq);
        c++;
      }

      myObject = new Frequencer();
      myObject.setSpace("hogehogehugahuga".getBytes());
      myObject.setTarget("hogehogehugahuga".getBytes());
      freq = myObject.subByteFrequency(4, 8);
      if (2 != freq) {
        System.out.println(
            "frequency() for hogehogehugahuga, should return 2, when taget is hogehogehugahuga in (4, 8). But it returns "
                + freq);
        c++;
      }
      ...
      if (0 != freq) {
        System.out
            .println("frequency() for empty space, should return 0, when taget is not empty. But it returns " + freq);
        c++;
      }
      ...
      if (3 != freq) {
        System.out
            .println("SubBytefrequency() for AAAB, should return 3, when taget is AAAAB[0:1]. But it returns " + freq);
        c++;
      }
      ...
      if (3 != freq) {
        System.out
            .println("SubBytefrequency() for AAAB, should return 3, when taget is AAAAB[1:2]. But it returns " + freq);
        c++;
      }
      ...
      if (2 != freq) {
        System.out
            .println("SubBytefrequency() for AAAB, should return 2, when taget is AAAAB[1:3]. But it returns " + freq);
        c++;
      }
      ...
      if (1 != freq) {
        System.out
            .println("SubBytefrequency() for AAAB, should return 1, when taget is AAAAB[4:5]. But it returns " + freq);
        c++;
      }
    } catch (Exception e) {
    ...
    try {
      ...
      value = myObject.estimation();
      if ((value < 3.9999) || (4.0001 < value)) {
        System.out.println("IQ for 32103 in 3210321001230123 should be 4.0. But it returns " + value);
        c++;
      }
      ...
      myObject.setTarget("".getBytes());
      value = myObject.estimation();
      if ((value < -0.0001) || (0.0001 < value)) {
        System.out.println("IQ for \"\" in 3210321001230123 should be 0.0. But it returns " + value);
        c++;
      }
      ...
      myObject.setTarget("00".getBytes());
      value = myObject.estimation();
      if (value < Double.MAX_VALUE - 0.0001 || Double.isNaN(value)) {
        System.out.println("IQ for \"\" in 3210321001230123 should be 0.0. But it returns " + value);
        c++;
      }
    } catch (Exception e) {
